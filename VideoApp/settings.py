...
SECRET_KEY = 'django-insecure--vp_4odp%#h2x5jln&gvwbnke12%o^b#j%#tb5sn6dhorrc2_s'
...
CSRF_COOKIE_SECURE = True  # Use False for development without HTTPS
...
# Remove 'email' from the REQUIRED_FIELDS as it is already set as USERNAME_FIELD
